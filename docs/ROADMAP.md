...
- Case 列表、详情、CRUD
- Case 自动案件号生成
- Case Detail 中案件事項 / Checklist 管理
- Task 后端模型/API 保留，前端菜单和案件详情 CRUD 已下线
- Case Detail 中 Timeline 追加
- 担当者管理
- 案件・担当設定管理
- 案件事项 / Checklist 模板管理
- よくある項目 `ChecklistItemPreset` 管理与标准项目导入
- 新規受付支持只创建顾客，案件信息改为可选
- 顾客详情页家族信息内联编辑
- 前端设置页修改密码与 root 账号管理
- マイナンバー加密保存
- django-axes 登录失败 3 次锁定 1 小时
- 会計ダッシュボード
...
- 清風合格通知書记录化保存等后续功能（基础 PDF 添加文字工具已存在，继续开发暂停）
- 复杂权限系统
- 通知发送
